        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <br><br>
                    <form action="{{ url('surat/disposisi-surat/updateDisposisi/' . $surat->id) }}" method="post"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="tujuan_disposisi" class="form-control" id="tujuan_disposisi" required>
                            ...
                            <div class="col-md-6">
                                <label for="waktu" class="col-form-label">Waktu
                                    <span class="text-danger fw-bold">*</span>
                                </label>
                                <input class="form-control" type="datetime-local" name="waktu" id="waktu"
                                    value="{{ $surat->waktu }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="" name="disposisi_singkat" id="disposisi_singkat" class="form-control"
                                placeholder="Masukkan pesan disposisi singkat" required>{{ $surat->disposisi_singkat }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="disposisi_narasi">Disposisi Narasi
                                <span class="text-primary fw-bold">* (opsional)</span>
                            </label>
                            <textarea type="" name="disposisi_narasi" id="disposisi_narasi" class="form-control"
                                placeholder="Masukkan pesan disposisi narasi">{{ $surat->disposisi_narasi }}</textarea>
                        </div>
