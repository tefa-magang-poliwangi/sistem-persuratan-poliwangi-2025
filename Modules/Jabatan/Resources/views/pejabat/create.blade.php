        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <form action="{{ url('jabatan/data-jabatan') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-md-6">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="date" name="mulai" required>
                            </div>
                            <div class="col-md-6">
                                <label for="example-text-input" class="col-form-label">Selesai <span class="text-danger fw-bold">*</span></label>
                                <input class="form-control" type="date" name="selesai" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-12">
